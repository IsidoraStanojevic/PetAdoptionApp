...
CREATE TABLE IF NOT EXISTS `ad` (
  ...
  `papers` tinyint(1) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `pasword_reset_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `forname` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `surname` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phonenumber` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
